        ...
        <div>
            <nav className="shadow w-screen bg-gray-800">
                <div className="container flex items-center justify-center p-6 mx-auto  capitalize text-gray-300">
                    ...
                    <Link to='/login' className={`${logincss} border-transparent  hover:text-gray-200 hover:border-blue-500 active:border-b-2 hover:border-b-2 active:border-blue-500 mx-1.5 sm:mx-6`} onClick={() => { setHomeflag(0), setAboutflag(0), setLoginflag(1) }}>Login</Link>
